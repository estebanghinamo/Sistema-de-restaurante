...
VALUES
		(1,N'Salón Industrial'),
		(2,N'Patio de la Fábrica'),
		(3,N'Bar Craft Beer');
...
VALUES
		(1,N'La Fábrica Burger',N'30-77889911-5');
...
VALUES
		(1,1,N'La Fábrica Burger - Cerro de las Rosas',N'Rafael Núñez',N'4600',N'Cerro de las Rosas',1,N'5009',N'3517003003',120,10,2),
		(1,2,N'La Fábrica Burger - Argüello',N'Rafael Núñez',N'4620',N'Argüello',1,N'5009',N'3517003004',90,15,2);

INSERT INTO dbo.zonas_sucursales 
(nro_restaurante, nro_sucursal, cod_zona, cant_comensales, permite_menores, habilitada)
VALUES
	(1,1,1,60,1,1),(1,1,2,35,1,1),(1,1,3,25,0,1),
	(1,2,1,40,1,1),(1,2,2,30,1,1),(1,2,3,20,0,1);
...
/* ============================================
   CONTENIDOS PROMOCIONALES — RESTAURANTE 3
   ============================================*/
...
VALUES
(1,1,N'Burger “Doble Remachada” con cheddar, panceta y salsa fábrica',N'https://lasrecetasdelchef.net/wp-content/uploads/2020/04/hamburguesa-doble-con-queso-1024x576.jpg',0,0.15,1),
(1,2,N'Combo “Turno Noche”: burger + papas rústicas + craft beer',N'https://i.ytimg.com/vi/mdeeMLKdFc4/maxresdefault.jpg',0,0.15,1),
(1,3,N'Smash Burger ahumada con cebolla caramelizada y pepinillos',N'https://corp.ametllerorigen.com/wp-content/uploads/2023/10/receta-ametller-origen-smash-burger.webp',0,0.20,2),
(1,4,N'Chicken burger crocante con coleslaw y mayo especiada',N'https://www.infobae.com/resizer/v2/V7C6QP6QDBHQFF6KWGHBUD5WGY.jpg?auth=cb58fc53fa308de6133301ee39c75ac5cb8766f035f4c2dd83ec2d0871e7594d',0,0.15,2);
GO
/*
update contenidos
