...
ADD destacado NVARCHAR(50) not null default '';
UPDATE dbo.restaurantes
SET destacado = 'PREMIUM'
...
END;
    ...
    /* 1) Restaurante */
SELECT r.nro_restaurante, r.razon_social, r.cuit/*,r.destacado*/
...
END;
	...
	--DECLARE @observaciones           NVARCHAR(400)           = JSON_VALUE(@json, '$.reserva.observaciones');
...
(
    ...
    cancelada, fecha_cancelacion/*, observaciones*/
)
